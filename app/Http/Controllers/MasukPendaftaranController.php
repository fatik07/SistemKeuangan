...
class MasukPendaftaranController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        ->where("t_mutasi_kas.jenis_kas", 'pendaftaran')
        ...
        // dd($sql);
        return view('pages/kas-masuk/pendaftaran/indexPendaftaran', compact('sql'));
    }
