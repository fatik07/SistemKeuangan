...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('stisla-master/assets/css/component.css') }}">
</head>
    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
          ...
          <div class="p-4 m-3">
            ...
            <form method="POST" action="/login" class="needs-validation" novalidate="">
              ...
              <div class="form-group">
                ...
                <input id="email" type="email" name="email" class="form-control" name="email" tabindex="1" required
                  autofocus>
        ...
        <div
          ...
          data-background="{{ asset('stisla-master/assets/img/unsplash/login-bg.jpg') }}">
